...
pub fn save_nonlinear_checkpoint(
    ...
    vel: &[f64],
    accel: &[f64],
    behaviors: &[Box<dyn sc_element::behavior::ElementBehavior>],
) -> io::Result<()> {
...
pub fn load_nonlinear_checkpoint(
    dir: &Path,
    model: &sc_core::model::Model,
    behaviors: &mut [Box<dyn sc_element::behavior::ElementBehavior>],
...
mod tests {
    ...
    fn test_nonlinear_checkpoint_roundtrip() {
        ...
        use sc_element::behavior::{Ctx, ElementBehavior, LocalVec};

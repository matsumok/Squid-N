...
計算根拠（[calc_basis](../calc_basis/README.md)）の出典としては用いない。計算根拠は
...
> `docs/v_and_v/断面検定_参照実装照合.md` を参照（対象: rc.rs/steel.rs/src_cft.rs/
...
> 詳細・未実装項目は `docs/v_and_v/非線形モデル_参照実装照合.md`。
